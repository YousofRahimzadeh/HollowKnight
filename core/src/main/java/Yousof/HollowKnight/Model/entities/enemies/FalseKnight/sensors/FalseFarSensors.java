...
public class FalseFarSensors {
    ...
    public void createSensors(Body body , float hx , float hy){
        ...
        float HSensorWidth = (750f + 550f + 550f) / Constants.PPM / 2f;
        float HSensorHeight = hy + (100f + 100f) / Constants.PPM;
        ...
        body.createFixture(fdef).setUserData("FalseKnight_knight_far");
