...
public class EnemyFactory {
    public static Enemy createEnemy(String type, World world, float x, float y) {
        switch (type) {
            ...
            case "WingedSentry":
                return new WingedSentry(world, x, y , 20 , 2f);
            case "CrystalGuardian":
                return new CrystalGuardian(world, x, y ,20 ,  AnimationManager.CrystalGuardian , 20f);
            case "FalseKnight":
                return new FalseKnightEnemy(world, x, y , 150);
            default:
