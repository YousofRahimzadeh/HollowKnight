...
public class FalseSurroundSensors {
    public int rightSensor;
    public int leftSensor;
    public int groundSensor;

    public FalseSurroundSensors(){
        rightSensor = 0;
        leftSensor = 0;
        groundSensor = 0;
    }
    ...
    public void createSensors(Body body , float hx , float hy){
        ...
        body.createFixture(fdef).setUserData("FalseKnight_sensor_wall_right");

        shape.setAsBox(sideSensorWidth, sideSensorHeight, new Vector2(-hx - sideSensorWidth, 0), 0);
        body.createFixture(fdef).setUserData("FalseKnight_sensor_wall_left");
