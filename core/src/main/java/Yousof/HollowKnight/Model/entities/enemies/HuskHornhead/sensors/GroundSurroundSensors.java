package Yousof.HollowKnight.Model.entities.enemies.groundEnemy.sensors;
...
public class GroundSurroundSensors {
    ...
    public void createSensors(Body body , float hx , float hy){
        ...
        body.createFixture(fdef).setUserData("GroundEnemy_sensor_wall_right");

        shape.setAsBox(sideSensorWidth, sideSensorHeight, new Vector2(-hx - sideSensorWidth, 0), 0);
        body.createFixture(fdef).setUserData("GroundEnemy_sensor_wall_left");

        shape.setAsBox(cliffSensorWidth, cliffSensorHeight, new Vector2(hx + cliffSensorWidth, -hy - cliffSensorHeight), 0);
        body.createFixture(fdef).setUserData("GroundEnemy_sensor_cliff_right");

        shape.setAsBox(cliffSensorWidth, cliffSensorHeight, new Vector2(-hx - cliffSensorWidth, -hy - cliffSensorHeight), 0);
        body.createFixture(fdef).setUserData("GroundEnemy_sensor_cliff_left");
